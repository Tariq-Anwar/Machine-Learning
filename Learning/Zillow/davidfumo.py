# Credit: https://www.kaggle.com/davidfumo/boosted-trees-lb-0-0643707/code
...
train  = pd.read_csv(open(os.path.join(path, "train_2016_v2.csv"), "r"))
...
sample = pd.read_csv(open(os.path.join(path, "sample_submission.csv"), "r"))
print("   ...")
...
properties  = pd.read_csv(open(os.path.join(path, "properties_2016.csv"), "r"))
...
train = pd.read_csv(open(os.path.join(path, "train_2016_v2.csv"), "r"),parse_dates=["transactiondate"])
properties  = pd.read_csv(open(os.path.join(path, "properties_2016.csv"), "r"))
submission = pd.read_csv(open(os.path.join(path, "sample_submission.csv"), "r"))
